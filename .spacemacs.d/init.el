...
you should place your code here."
  ...
  (push '(ibuffer-mode :stick t :height 15 :position bottom) popwin:special-display-config)

  (setq persistent-scratch-save-file (concat dotspacemacs-directory ".persistent-scratch"))
  (setq persistent-scratch-backup-directory (concat dotspacemacs-directory ".persistent-scratch-backup"))
  (persistent-scratch-setup-default)

  (setq projectile-project-search-path (list (concat (getenv "WD_ROOT") "/issues") (getenv "WD_ROOT")))


  ;; emacs-ja.info
  ;; https://ayatakesi.github.io
  ;; http://emacs.rubikitch.com/emacs245-manual-ja/
  (add-to-list 'Info-directory-list (concat dotspacemacs-directory "info"))
